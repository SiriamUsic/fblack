...
if Dev(msg) then
if text == "تحديث" or text == "اعاده تشغيل" then
LuaTele.sendText(Sudo_Id,0,"⌯ تم اعاده تشغيل الملفات بنجاح ")
dofile('black.lua')  
return false 
end
...
send(msg.chat_id,msg.id,"⌯ اهلا بك عزيزي المطور\n","md",true, false, false, true, reply_markup)
return false 
end
---
...
return send(msg_chat_id,msg_id,'⌯ عذرا هذا الملف غير متطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
...
keyboardd.inline_keyboard = {
{
{text = '◜𝑚𝑦 𝑑𝑒𝑣◞', url = "https://t.me/BK_ZT"}
},
{
{text = '◜𝑠𝑜𝑢𝑟𝑐𝑒◞', url = "https://t.me/CR_T2"},
},
}
local msg_id = msg.id/2097152/0.5 
...
{
{text = 'ِّّ◜𝑠𝑜𝑢𝑟𝑐𝑒◞', url = 't.me/CR_T2'}, 
},
}

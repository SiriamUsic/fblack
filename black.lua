...
send(msg.chat_id,msg.id,"※ مرحبا عزيزي في مصنع الحمايه المجاني لسورس تيربو \n※ مبرمج السورس @Salah_officiall - @MA_RLOW","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
send(msg.chat_id,msg.id,"※ التوكن غلط اتأكد منه وتعالا")
end
if text == "صنع بوت" then
if Redis:get(black..msg.sender.user_id.."my:bot") then
return send(msg.chat_id,msg.id,"※ انت صانع بوت يسطا احذفو ونصب بعدها عادي")
end
...
send(msg.chat_id,msg.id, "\n※ حذفتلك بوتك يلا غور من هنا","md",true)  
else
send(msg.chat_id,msg.id, "\n※ انت مصنعتش بوت اصلا","md",true)  
end
end
...
{
{text = 'المطور مارلو', url = "https://t.me/MA_RLOW"},
},
}
local msg_id = msg.id/2097152/0.5 
...
{
{text = 'ِّّ◜𝑠𝑜𝑢𝑟𝑐𝑒◞', url = 't.me/MARLOW5_5'}, 
},
}

...
local TestText = "𝚂𝙾𝚞𝚁𝙲𝙴 𝚃𝙴𝙻𝙴𝙶𝙾𝙳\n— — — — — — — — —\n ⌔*َdev name⌔* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔*َbio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𝚂𝙾𝚞𝚁𝙲𝙴 𝚃𝙴𝙻𝙴𝙶𝙾𝙳', url = "https://t.me/CR_T2"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '𝚂𝙰𝙻𝙰𝙷 𝙷𝙴𝙼𝙳𝙰𝙽', url = "https://t.me/BK_ZT"}
},
{
{text = '𝚂𝙾𝚞𝚁𝙲𝙴 𝚃𝙴𝙻𝙴𝙶𝙾𝙳', url = "https://t.me/C_T2"},
},
}
local msg_id = msg.id/2097152/0.5 
...
photo = "https://t.me/suorceTelegod/2"
local T =[[
ـــــــــــــــــــــــــــــــــــــــــــ
⌔ 𝚂𝙾𝚞𝚁𝙲𝙴 𝚃𝙴𝙻𝙴𝙶𝙾𝙳 ⌔
ـــــــــــــــــــــــــــــــــــــــــــ
⌔ 𝙳𝙴𝚅 >> [˹𝚂𝙰𝙻𝙰𝙷 𝙷𝙴𝙼𝙳𝙰𝙽.](t.me/BK_ZT)
ـــــــــــــــــــــــــــــــــــــــــــ 
⌔ >> [˹ 𝚂𝙾𝚞𝚁𝙲𝙴 𝚃𝙴𝙻𝙴𝙶𝙾𝙳 .](t.me/CR_T2)
ـــــــــــــــــــــــــــــــــــــــــــ
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ِّّ𝚂𝙾𝚞𝚁𝙲𝙴 𝚃𝙴𝙻𝙴𝙶𝙾𝙳', url = 't.me/CR_T2'}, 
},
}
